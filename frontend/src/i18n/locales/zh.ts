...
const zh: TranslationMessages = {
  article: {
    ...
    readingMode: {
      appearance: '阅读外观',
      appearanceAdvanced: '高级外观',
      appearanceClose: '关闭阅读外观',
      appearanceDecreaseFontSize: '减小字号',
      appearanceDensity: '阅读密度',
      appearanceDensityBalanced: '均衡',
      appearanceDensityCompact: '紧凑',
      appearanceDensityRelaxed: '舒展',
      appearanceFontSize: '字号',
      appearanceIncreaseFontSize: '增大字号',
      contents: '目录',
      contentsClose: '关闭目录',
      contentsCurrent: '当前',
      contentsEmpty: '这篇文章没有章节。',
      contentsTop: '返回顶部',
      enter: '进入阅读模式',
      entered: '已进入阅读模式，焦点已移至文章正文。',
      exit: '退出阅读模式',
      exited: '已退出阅读模式。',
      find: '在文章中查找',
      appearanceSaveFailed: '无法保存阅读外观。',
      appearanceSavePending: '更改等待保存',
      appearanceSaved: '已保存',
      appearanceSaving: '正在保存…',
      moreActions: '更多阅读操作',
      appearanceRetrySave: '重新保存',
      appearanceTitle: '阅读外观',
      appearanceRestoreDefault: '恢复默认排版',
      appearanceWidth: '正文宽度',
      progress: '阅读进度：{percent}%',
      regionLabel: '文章阅读区域',
      resumedAt: '已从 {percent}% 继续阅读',
      linkPreview: '链接页面',
      returnToReading: '返回阅读',
      showArticleList: '显示文章列表',
      translationBilingual: '双语',
      translationCurrent: '翻译：{mode}',
      translationDisplay: '翻译显示方式',
      translationLoading: '正在翻译…',
      translationOriginal: '原文',
      translationTranslation: '仅译文',
    },
    summary: {
  ...
  setting: {
    ...
    typography: {
      ...
      contentWidth: '正文宽度',
      contentWidthDesc: '控制较大屏幕上正文栏的最大宽度',
      contentWidthNarrow: '窄',
      contentWidthComfortable: '舒适',
      contentWidthWide: '宽',
      paragraphSpacing: '段落间距',
      paragraphSpacingDesc: '控制文章段落之间的垂直留白',
      paragraphSpacingCompact: '紧凑',
      paragraphSpacingComfortable: '舒适',
      paragraphSpacingRelaxed: '舒展',
      readerPreset: '阅读风格',
      readerPresetFocus: '专注',
      readerPresetFocusDesc: '适合日常阅读的均衡排版',
      readerPresetMagazine: '杂志',
      readerPresetMagazineDesc: '适合深度报道与专题文章的编辑式节奏',
      readerPresetBook: '书卷',
      readerPresetBookDesc: '衬线字体与舒展的阅读节奏',
      readerPresetCompact: '紧凑',
      readerPresetCompactDesc: '更紧凑的文字和更宽的正文栏',
      readerPresetCustom: '自定义',
      readerPreview: '阅读预览',
      readerPreviewHeading: '一段舒展的阅读节奏',
      readerPreviewFirst: '排版改动会即时反映在 RSS 正文中。',
      readerPreviewSecond: '字体、宽度和段落节奏独立于应用主题颜色。',
      readerCanvas: '阅读颜色',
      readerCanvasTheme: '跟随应用主题',
      readerCanvasCustom: '自定义阅读画布',
      readerCanvasBackground: '背景色',
      readerCanvasText: '正文字色',
      readerCanvasContrast: '正文对比度：{ratio}:1',
      readerCanvasContrastInvalid: '请选择对比度至少为 4.5:1 的颜色',
      fontMonospace: '等宽字体',
    ...
    feed: {
      ...
      autoReadingMode: '自动进入阅读模式',
      autoReadingModeDesc: '此订阅源的 RSS 正文可用时，自动进入专注阅读视图',
      autoReadingModeExternalDesc: '外部浏览器视图优先；切回应用内视图后会保留此偏好。',
    ...
    general: {
      ...
      theme: '主题',
      themeDesc: '为整个应用选择内置外观',
      themeAutoDesc: '根据系统外观在 Paper 与 Ink 间切换',
      themeHighContrast: '高对比度',
      themeHighContrastDesc: '为文字和控件提供最高对比度',
      themeInk: 'Ink',
      themeInkDesc: '适合弱光阅读的专注深色外观',
      themePaper: 'Paper',
      themePaperDesc: '适合日常阅读的平衡浅色外观',
      themeSepia: 'Sepia',
      themeSepiaDesc: '适合长文阅读的暖色外观',
      customTheme: {
        title: '自定义主题',
        description: '调整应用外壳的颜色和界面字体，不会改变阅读排版。',
        new: '新建自定义主题',
        newName: '自定义主题',
        import: '导入主题',
        export: '导出主题',
        empty: '创建主题以自定义应用颜色和界面字体。',
        list: '自定义主题列表',
        rename: '重命名主题',
        name: '主题名称',
        saveName: '保存主题名称',
        ...
        resetToken: '恢复继承的颜色',
        resetProfile: '重置主题覆盖',
        invalidImport: '主题文件无效',
        contrastPass: '所有主题对比度检查均通过',
        contrastFail: '部分主题对比度需要调整',
        contrastDetails: '对比度检查',
        contrastPrimary: '主文字',
        contrastSecondary: '次文字',
        contrastAccent: '强调文字',
        contrastBackgroundWarning: '固定抽屉警告图标',
        contrastAccentForeground: '强调操作',
        contrastAccentHover: '强调操作悬停',
        contrastSelection: '选中内容',
        contrastRailSecondary: '活动栏文字',
        contrastRailAccent: '活动栏强调文字',
        contrastPanelPrimary: '面板主文字',
        contrastPanelSecondary: '面板次文字',
        contrastPanelAccent: '面板强调文字',
        contrastPanelWarning: '面板警告图标',
        contrastHoverPrimary: '悬停主文字',
        contrastHoverSecondary: '悬停次文字',
        contrastHoverAccent: '悬停强调文字',
        contrastHoverWarning: '悬停警告图标',
        contrastSelectedAccent: '选中项文字',
        contrastSelectedSecondary: '选中项次文字',
        contrastSelectedWarning: '选中项警告图标',
        contrastUnreadBadge: '未读徽标',
        contrastBlocked: '自定义主题必须保持可读的文字对比度。',
        themeOptionDescription: '自定义应用外观',
        state: {
          favorite: '收藏',
          readLater: '稍后阅读',
          info: '信息',
        ...
        token: {
          ...
          'accent-color': '强调色',
          'accent-hover': '强调悬停色',
          'accent-text-color': '强调文字',
          'accent-foreground': '强调前景',
          'selection-background': '选中背景色',
          'selection-color': '选中文字色',
          'border-color': '边框颜色',
          'mark-bg-color': '高亮背景',
          'table-stripe-color': '表格斑马纹',
          'code-bg-color': '代码背景',
          'code-border-color': '代码边框',
          'syntax-plain': '语法普通文字',
          'syntax-comment': '语法注释',
          'syntax-keyword': '语法关键字',
          'syntax-string': '语法字符串',
          'syntax-title': '语法标题',
          'syntax-attribute': '语法属性',
          'syntax-meta': '语法元数据',
          'syntax-built-in': '语法内置项',
          'syntax-formula-background': '公式背景',
          'state-favorite-color': '收藏文字',
          'state-favorite-background': '收藏背景',
          'state-favorite-border': '收藏边框',
          'state-read-later-color': '稍后阅读文字',
          'state-read-later-background': '稍后阅读背景',
          'state-read-later-border': '稍后阅读边框',
          'state-info-color': '信息文字',
          'state-info-background': '信息背景',
          'state-info-border': '信息边框',
          'state-success-color': '成功文字',
          'state-success-background': '成功背景',
          'state-success-border': '成功边框',
          'state-warning-color': '警告文字',
          'state-warning-background': '警告背景',
          'state-warning-border': '警告边框',
          'state-danger-color': '错误文字',
          'state-danger-background': '错误背景',
          'state-danger-border': '错误边框',
          'unread-badge-background': '未读徽标背景',
          'unread-badge-color': '未读徽标文字',
          'overlay-backdrop': '遮罩背景',
          'overlay-shadow-color': '抽屉阴影颜色',
          'media-overlay-background': '媒体遮罩',
          'media-overlay-hover-background': '媒体遮罩悬停',
          'media-overlay-strong-background': '媒体强遮罩',
          'media-overlay-foreground': '媒体前景',
          'media-overlay-muted-foreground': '媒体弱前景',
          'media-control-background': '媒体控件背景',
          'media-control-hover-background': '媒体控件悬停',
          'media-control-foreground': '媒体控件文字',
          'media-badge-background': '媒体徽标背景',
          'media-badge-foreground': '媒体徽标文字',
          'media-viewer-background': '媒体查看器背景',
          'media-viewer-border': '媒体查看器边框',
        },
      },
    },
    network: {
    ...
    reading: {
      ...
      markReadOnScrollDesc: 'RSS 正文阅读进度达到 50% 后标记为已读。',
