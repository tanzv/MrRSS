...
const zh: TranslationMessages = {
  article: {
    ...
    readingMode: {
      ...
      appearanceUseThemeStyle: '使用主题推荐样式',
  ...
  setting: {
    ...
    typography: {
      ...
      readerPresetNight: '夜读',
      readerPresetNightDesc: '适合弱光阅读的舒缓节奏',
      readerPresetBook: '书卷',
      readerPresetBookDesc: '衬线字体与舒展的阅读节奏',
      readerPresetClarity: '清晰',
      readerPresetClarityDesc: '更大的字号与更从容的行间节奏',
      readerPresetCompact: '紧凑',
      readerPresetCompactDesc: '更紧凑的文字和更宽的正文栏',
      readerPresetCustom: '自定义',
      readerPresetRecommended: '{theme} 主题推荐',
      readerPresetThemeAria: '{style}，对应 {theme} 主题',
      readerPresetThemeRecommendedAria: '{style}，对应 {theme} 主题，当前推荐',
      readerPreview: '阅读预览',
