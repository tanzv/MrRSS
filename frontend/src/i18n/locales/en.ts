...
const en: TranslationMessages = {
  article: {
    ...
    readingMode: {
      ...
      appearanceUseThemeStyle: 'Use theme recommendation',
  ...
  setting: {
    ...
    typography: {
      ...
      readerPresetNightDesc: 'A softer rhythm for low-light reading',
      readerPresetBook: 'Book',
      readerPresetBookDesc: 'Serif type with a relaxed rhythm',
      readerPresetClarity: 'Clarity',
      readerPresetClarityDesc: 'Larger type with more room to follow each line',
      readerPresetCompact: 'Compact',
      readerPresetCompactDesc: 'Dense text with a wider column',
      readerPresetCustom: 'Custom',
      readerPresetRecommended: 'Recommended for {theme}',
      readerPresetThemeAria: '{style}, {theme} theme style',
      readerPresetThemeRecommendedAria: '{style}, {theme} theme style, recommended',
