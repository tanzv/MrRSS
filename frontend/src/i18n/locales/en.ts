...
const en: TranslationMessages = {
  article: {
    ...
    readingMode: {
      ...
      appearanceAdvanced: 'Advanced appearance',
      appearanceClose: 'Close reading appearance',
      appearanceDecreaseFontSize: 'Decrease font size',
      appearanceDensity: 'Density',
      appearanceDensityBalanced: 'Balanced',
      appearanceDensityCompact: 'Compact',
      appearanceDensityRelaxed: 'Relaxed',
      appearanceFontSize: 'Font size',
      appearanceIncreaseFontSize: 'Increase font size',
      contents: 'Contents',
      contentsClose: 'Close contents',
      contentsCurrent: 'Current',
      contentsEmpty: 'This article has no sections.',
      contentsTop: 'Back to top',
      ...
      find: 'Find in article',
      appearanceSaveFailed: 'Could not save reading appearance',
      appearanceSavePending: 'Changes waiting to save',
      appearanceSaved: 'Saved',
      appearanceSaving: 'Saving…',
      moreActions: 'More reading actions',
      appearanceRetrySave: 'Retry save',
      appearanceTitle: 'Reading appearance',
      appearanceRestoreDefault: 'Restore default typography',
      appearanceWidth: 'Article width',
      progress: 'Reading progress: {percent}%',
      regionLabel: 'Article reader',
      resumedAt: 'Resumed at {percent}%',
      linkPreview: 'Linked page',
      returnToReading: 'Back to reading',
      showArticleList: 'Show article list',
      translationBilingual: 'Bilingual',
      translationCurrent: 'Translation: {mode}',
      translationDisplay: 'Translation display',
      translationLoading: 'Translating…',
      translationOriginal: 'Original',
      translationTranslation: 'Translation only',
    },
    summary: {
  ...
  setting: {
    ...
    typography: {
      ...
      contentWidthDesc: 'Maximum width of the article column on larger screens',
      contentWidthNarrow: 'Narrow',
      contentWidthComfortable: 'Comfortable',
      contentWidthWide: 'Wide',
      paragraphSpacing: 'Paragraph Spacing',
      paragraphSpacingDesc: 'Vertical space between article paragraphs',
      paragraphSpacingCompact: 'Compact',
      paragraphSpacingComfortable: 'Comfortable',
      paragraphSpacingRelaxed: 'Relaxed',
      readerPreset: 'Reading Style',
      readerPresetFocus: 'Focus',
      readerPresetFocusDesc: 'Balanced for everyday reading',
      readerPresetMagazine: 'Magazine',
      readerPresetMagazineDesc: 'Editorial rhythm for feature stories',
      readerPresetBook: 'Book',
      readerPresetBookDesc: 'Serif type with a relaxed rhythm',
      readerPresetCompact: 'Compact',
      readerPresetCompactDesc: 'Dense text with a wider column',
      readerPresetCustom: 'Custom',
      readerPreview: 'Reading Preview',
      readerPreviewHeading: 'A measured reading rhythm',
      readerPreviewFirst: 'Typography changes are reflected in RSS articles as you read.',
      readerPreviewSecond: 'Font, width, and paragraph rhythm remain independent of the app theme.',
      readerCanvas: 'Reading Colors',
      readerCanvasTheme: 'Follow App Theme',
      readerCanvasCustom: 'Custom Reading Canvas',
      readerCanvasBackground: 'Background Color',
      readerCanvasText: 'Text Color',
      readerCanvasContrast: 'Text contrast: {ratio}:1',
      readerCanvasContrastInvalid: 'Choose colors with at least 4.5:1 contrast',
    ...
    feed: {
      ...
      autoReadingMode: 'Automatically Enter Reading Mode',
      autoReadingModeDesc: "Open this feed's available RSS content in the focused reading view",
      autoReadingModeExternalDesc:
        'External browser view takes priority; this preference is retained until you return to an in-app view.',
    ...
    general: {
      ...
      theme: 'Theme',
      themeDesc: 'Choose a built-in appearance for the entire app',
      themeAutoDesc: 'Use Paper or Ink to match your system',
      themeHighContrast: 'High Contrast',
      themeHighContrastDesc: 'Maximum contrast for readable controls and text',
      themeInk: 'Ink',
      themeInkDesc: 'A focused dark appearance for low-light reading',
      themePaper: 'Paper',
      themePaperDesc: 'A balanced light appearance for daily reading',
      themeSepia: 'Sepia',
      themeSepiaDesc: 'A warm appearance for long-form reading',
      customTheme: {
        title: 'Custom themes',
        description: 'Tune the application shell without changing reader typography.',
        new: 'New custom theme',
        newName: 'Custom theme',
        import: 'Import themes',
        export: 'Export themes',
        empty: 'Create a theme to customize application colors and interface font.',
        list: 'Custom themes',
        rename: 'Rename theme',
        name: 'Theme name',
        saveName: 'Save theme name',
        ...
        resetToken: 'Reset to inherited value',
        resetProfile: 'Reset theme overrides',
        invalidImport: 'Invalid theme file',
        contrastPass: 'All theme contrast checks pass',
        contrastFail: 'Some theme contrast checks need improvement',
        contrastDetails: 'Contrast checks',
        contrastPrimary: 'Primary text',
        contrastSecondary: 'Secondary text',
        contrastAccent: 'Accent text',
        contrastBackgroundWarning: 'Pinned drawer warning indicator',
        contrastAccentForeground: 'Accent action',
        contrastAccentHover: 'Accent action hover',
        contrastSelection: 'Selection',
        contrastRailSecondary: 'Activity rail text',
        contrastRailAccent: 'Activity rail accent',
        contrastPanelPrimary: 'Panel primary text',
        contrastPanelSecondary: 'Panel secondary text',
        contrastPanelAccent: 'Panel accent text',
        contrastPanelWarning: 'Panel warning indicator',
        contrastHoverPrimary: 'Hover primary text',
        contrastHoverSecondary: 'Hover secondary text',
        contrastHoverAccent: 'Hover accent text',
        contrastHoverWarning: 'Hover warning indicator',
        contrastSelectedAccent: 'Selected item text',
        contrastSelectedSecondary: 'Selected item secondary text',
        contrastSelectedWarning: 'Selected item warning indicator',
        contrastUnreadBadge: 'Unread badge',
        contrastBlocked: 'Custom themes must keep readable text contrast.',
        themeOptionDescription: 'Custom application appearance',
        state: {
          favorite: 'Favorite',
        ...
        group: {
          surface: 'Surfaces',
          text: 'Text',
          accent: 'Accent and selection',
          border: 'Borders',
          state: 'States and badges',
          reader: 'Reader-adjacent controls',
        },
        token: {
          'bg-primary': 'Primary background',
          'bg-secondary': 'Secondary background',
          'bg-tertiary': 'Tertiary background',
          'surface-rail': 'Activity rail',
          ...
          'mark-bg-color': 'Highlight background',
          'table-stripe-color': 'Table stripe',
          'code-bg-color': 'Code background',
          'code-border-color': 'Code border',
          'syntax-plain': 'Syntax plain text',
          'syntax-comment': 'Syntax comments',
          'syntax-keyword': 'Syntax keywords',
          'syntax-string': 'Syntax strings',
          'syntax-title': 'Syntax titles',
          'syntax-attribute': 'Syntax attributes',
          'syntax-meta': 'Syntax metadata',
          'syntax-built-in': 'Syntax built-ins',
          'syntax-formula-background': 'Formula background',
          'state-favorite-color': 'Favorite text',
          'state-favorite-background': 'Favorite background',
          'state-favorite-border': 'Favorite border',
          'state-read-later-color': 'Read later text',
          'state-read-later-background': 'Read later background',
          'state-read-later-border': 'Read later border',
          'state-info-color': 'Info text',
          'state-info-background': 'Info background',
          'state-info-border': 'Info border',
          'state-success-color': 'Success text',
          'state-success-background': 'Success background',
          'state-success-border': 'Success border',
          'state-warning-color': 'Warning text',
          'state-warning-background': 'Warning background',
          'state-warning-border': 'Warning border',
          'state-danger-color': 'Danger text',
          'state-danger-background': 'Danger background',
          'state-danger-border': 'Danger border',
          'unread-badge-background': 'Unread badge background',
          'unread-badge-color': 'Unread badge text',
          'overlay-backdrop': 'Overlay backdrop',
          'overlay-shadow-color': 'Drawer shadow color',
          'media-overlay-background': 'Media overlay',
          'media-overlay-hover-background': 'Media overlay hover',
          'media-overlay-strong-background': 'Strong media overlay',
          'media-overlay-foreground': 'Media foreground',
          'media-overlay-muted-foreground': 'Muted media foreground',
          'media-control-background': 'Media control',
          'media-control-hover-background': 'Media control hover',
          'media-control-foreground': 'Media control text',
          'media-badge-background': 'Media badge',
          'media-badge-foreground': 'Media badge text',
          'media-viewer-background': 'Media viewer background',
          'media-viewer-border': 'Media viewer border',
        },
      },
    },
    network: {
    ...
    reading: {
      ...
      markReadOnScrollDesc: 'Mark RSS articles as read after reaching 50% of the article body.',
  ...
  sidebar: {
    activity: {
      ...
      autoHideActivityBar: 'Auto-hide Activity Bar',
      ...
      pinActivityBar: 'Keep Activity Bar Visible',
      queuedTasks: 'Queued Tasks',
      readLater: 'Read Later',
      readerNavigation: 'Reader navigation',
      showActivityBar: 'Show Activity Bar',
